...
public class ApplicationImpl implements Application, Disposable
{
    ...
    public RestAction<Application.Bot> createBot()
    {
        ...
        return new RestAction<Application.Bot>(getJDA(), Route.Applications.CREATE_BOT.compile(getId()), null)
        {
            @Override
    ...
    {
        return new RestAction<Void>(getJDA(), Route.Applications.DELETE_APPLICATION.compile(getId()), null)
        {
            @Override
